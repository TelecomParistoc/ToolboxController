...
#define PWM1_INITIALIZE_DUTY_VALUE    2
...
void EPWM1_Initialize(void) {
    ...
    // CCP1M P1AP1Chi_P1BP1Dhi; P1M single; DC1B 32; 
    CCP1CON = 0x2C;

    // CCP1ASE operating; PSS1BD P1BP1D_0; PSS1AC P1AP1C_0; CCP1AS disabled; 
    ECCP1AS = 0x00;

    // P1DC 0; P1RSEN automatic_restart; 
    PWM1CON = 0x80;

    // STR1A P1A_to_CCP1M; STR1SYNC start_at_begin; STR1C P1C_to_port; STR1B P1B_to_port; STR1D P1D_to_port; 
    PSTR1CON = 0x01;
